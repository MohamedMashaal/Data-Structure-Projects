		...
		while (flag) {
			...
			if (tempInput == 1) {
				while (flag3) {
					...
					temp = sc.nextLine();
					if (temp.length() == 1) {
						if (temp.charAt(0) == 'A' || temp.charAt(0) == 'a' || temp.charAt(0) == 'B'
								|| temp.charAt(0) == 'b' || temp.charAt(0) == 'C' || temp.charAt(0) == 'c') {
				...
				temp = sc.next();
				if (temp.length() == 1) {
					if (temp.charAt(0) == 'A' || temp.charAt(0) == 'a' || temp.charAt(0) == 'B' || temp.charAt(0) == 'b'
				...
				tempVal = sc.nextInt();
				System.out.println(polySolver.evaluatePolynomial(tempChar, tempVal));
			}
				...
				while (flag2) {
					...
					tempInput = sc.nextInt();
					sc.nextLine();
					if (tempInput == 1 || tempInput == 2 || tempInput == 3 || tempInput == 4 || tempInput == 5
							|| tempInput == 6 || tempInput == 7 || tempInput == 8) {
						flag2 = false;
						flag3 = false;
					}
				}
