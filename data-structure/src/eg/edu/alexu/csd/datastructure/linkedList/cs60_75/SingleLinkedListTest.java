...
public class SingleLinkedListTest {
	...
	public void test() {
		...
		Point[] myPoints = { new Point(5, 3), new Point(1, 4), new Point(6, 4), new Point(3, 3), new Point(200, 54),
				new Point(4, 5) };
		...
		Point[] pointTest = { new Point(63, 78), new Point(2114, 8541), new Point(200, 54), new Point(4, 5) };
		for (int i = 0; i < 4; i++)
			assertEquals("Missed element at index " + i, pointTest[i], testList.get(i));
		...
		Point[] pointTest2 = { new Point(1, 4), new Point(6, 4), new Point(63, 78), new Point(2114, 8541),
				new Point(200, 54), new Point(4, 5) };
		for (int i = 0; i < 6; i++)
			assertEquals("Missed element at index " + i, pointTest2[i], n.get(i));
